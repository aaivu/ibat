...
xgb = xgb.XGBRegressor(
    colsample_bytree=0.7, learning_rate=0.1, max_depth=6, alpha=10, n_estimators=1000
)
...
rmse = np.sqrt(
    mean_squared_error(pred_dwell["dwell_time_in_seconds"], pred_dwell["XGBoost_class"])
)

print("RMSE (1): %f" % (rmse))

mape = mean_absolute_percentage_error(
    pred_dwell["dwell_time_in_seconds"], pred_dwell["XGBoost_class"]
)
print("MAPE (1): %f" % (mape))
